...
class TypesRESTOperations(object):
    """TypesRESTOperations operations.
    ...
    def get_classification_def_by_guid(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Optional["_models.JsonAtlasClassificationDef"]
    ...
    def get_entity_def_by_guid(
        self,
        guid,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.JsonAtlasEntityDef"]
    ...
    def get_term_template_def_by_guid(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Optional["_models.JsonAtlasStructDef"]
    ...
    def get_enum_def_by_guid(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Optional["_models.JsonAtlasEnumDef"]
    ...
    def get_relationship_def_by_guid(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Optional["_models.JsonAtlasRelationshipDef"]
    ...
    def get_type_def_by_guid(
        self,
        guid,  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.JsonAtlasBaseTypeDef"]
    ...
    def get_all_type_defs(
        self,
        include_term_template=False,  # type: Optional[bool]
        type="False",  # type: Optional[Union[str, "_models.Enum14"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.JsonAtlasTypesDef"
    ...
    def create_atlas_type_defs(
        self,
        types_def,  # type: "_models.JsonAtlasTypesDef"
        **kwargs  # type: Any
    ):
        # type: (...) -> Optional["_models.JsonAtlasTypesDef"]
    ...
    def get_type_def_headers(
        self,
        include_term_template=False,  # type: Optional[bool]
        type="False",  # type: Optional[Union[str, "_models.Enum14"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> List["_models.JsonAtlasTypeDefHeader"]
    ...
    def get_type_statistics(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "_models.JsonTypeStatistics"
