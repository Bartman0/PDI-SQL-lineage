...
class DiscoveryRESTOperations:
    """DiscoveryRESTOperations async operations.
    ...
    async def search_advanced(
        self,
        search_request: "_models.JsonSearchRequest",
        **kwargs
    ) -> Optional["_models.JsonAdvancedSearchResult"]:
    ...
    async def suggest(
        self,
        suggest_request: "_models.JsonSuggestRequest",
        **kwargs
    ) -> Optional["_models.JsonSuggestResult"]:
    ...
    async def auto_complete(
        ...
        **kwargs
    ) -> Optional["_models.JsonAutocompleteResult"]:
