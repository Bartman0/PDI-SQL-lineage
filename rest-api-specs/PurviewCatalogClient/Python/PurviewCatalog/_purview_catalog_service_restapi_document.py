...
class PurviewCatalogServiceRESTAPIDocument(object):
    ...
    :vartype entity_rest: PurviewCatalog.operations.EntityRESTOperations
    :ivar glossary_rest: GlossaryRESTOperations operations
    :vartype glossary_rest: PurviewCatalog.operations.GlossaryRESTOperations
    :ivar discovery_rest: DiscoveryRESTOperations operations
    :vartype discovery_rest: PurviewCatalog.operations.DiscoveryRESTOperations
    :ivar lineage_rest: LineageRESTOperations operations
    :vartype lineage_rest: PurviewCatalog.operations.LineageRESTOperations
    :ivar relationship_rest: RelationshipRESTOperations operations
    :vartype relationship_rest: PurviewCatalog.operations.RelationshipRESTOperations
    :ivar types_rest: TypesRESTOperations operations
    :vartype types_rest: PurviewCatalog.operations.TypesRESTOperations
    ...
    def __init__(
        ...
        sort="ASC",  # type: Optional[str]
        extended_info=None,  # type: Optional[bool]
    ...
    def __enter__(self):
        # type: () -> PurviewCatalogServiceRESTAPIDocument
