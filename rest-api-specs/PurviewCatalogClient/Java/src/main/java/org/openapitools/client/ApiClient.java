...
public class ApiClient {
    ...
    private String basePath = "https://catalog.purview.azure.com/api";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2020-12-01-preview/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://catalog.purview.azure.com/api
