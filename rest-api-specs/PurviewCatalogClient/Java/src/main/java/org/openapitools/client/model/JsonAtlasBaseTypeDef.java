 ...
 */
@ApiModel(description = "Base class that captures common-attributes for all Atlas types.")
...
public class JsonAtlasBaseTypeDef {
  ...
  **/
  ...
  public JsonAtlasBaseTypeDef lastModifiedTS(String lastModifiedTS) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.category, jsonAtlasBaseTypeDef.category) &&
        ...
        Objects.equals(this.lastModifiedTS, jsonAtlasBaseTypeDef.lastModifiedTS);
  }

  @Override
  public int hashCode() {
    return Objects.hash(category, createTime, createdBy, dateFormatter, description, guid, name, options, serviceType, typeVersion, updateTime, updatedBy, version, lastModifiedTS);
  }
